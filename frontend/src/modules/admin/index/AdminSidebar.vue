...
const isActive = (path) => {
  ...
  // Exact match for top-level parent lists
  if (path === '/admin/clients') return route.path === '/admin/clients';
  if (path === '/admin/experts') return route.path === '/admin/experts';
  if (path === '/admin/jobs') return route.path === '/admin/jobs';

  // For nested links, allow startsWith
