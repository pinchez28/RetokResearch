<template>
  <div class="p-4 sm:p-6 md:p-8 max-w-7xl mx-auto space-y-6">
    <h1 class="text-2xl sm:text-3xl font-bold mb-4">Client Activity Logs</h1>
              ...
              <span
                :class="{
                  'bg-green-200 text-green-800 px-2 py-1 rounded-full text-sm':
                    log.action === 'login',
                  'bg-blue-200 text-blue-800 px-2 py-1 rounded-full text-sm':
                    log.action === 'post_job',
    ...
    <div class="lg:hidden grid gap-4">
      ...
      >
        ...
        <p class="text-gray-600">
          <span class="font-medium">Email:</span> {{ log.email }}
        </p>
        <p class="text-gray-600">
